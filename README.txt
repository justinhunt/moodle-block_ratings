...
* Rename the ratings/ folder to the name of your module (eg "widget").
...
all the instances of the string "ratings" to your module name
(eg "widget"). If you are using Linux, you can use the following command
$ find . -type f -exec sed -i 's/ratings/widget/g' {} \;

* Rename the file lang/en/ratings.php to lang/en/widget.php
where "widget" is the name of your module. Also rename block_ratings.php
...
and you should find that this ratings has been added to the list of
installed modules.
